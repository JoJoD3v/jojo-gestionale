    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-warning text-dark">
                <h4 class="mb-0"><i class="bi bi-pencil me-2"></i>Modifica Cliente</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('clienti.update', $cliente) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" 
                               ...
                               placeholder="Es: cliente@esempio.it"
                               required />
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="note" 
                                  ...
                                  rows="4"
                                  placeholder="Es: Informazioni aggiuntive sul cliente">{{ old('note', $cliente->note) }}</textarea>
                        @error('note')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-warning">
                            <i class="bi bi-save me-1"></i>Aggiorna Cliente
                        </button>
                    </div>
                </form>
            </div>
