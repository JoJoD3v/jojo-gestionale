    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0"><i class="bi bi-briefcase-fill me-2"></i>Nuovo Lavoro</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('lavori.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" 
                               ...
                               value="{{ old('data_lavoro', date('Y-m-d')) }}" 
                               required />
                        @error('data_lavoro')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" 
                                   ...
                                   id="stato_da_fare" 
                                   value="da_fare" 
                                   {{ old('stato', 'da_fare') == 'da_fare' ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-1"></i>Salva Lavoro
                        </button>
                    </div>
                </form>
            </div>
